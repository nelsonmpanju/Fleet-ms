...
frappe.ui.form.on('Fuel Requests', {
    ...
    refresh: function (frm, cdt, cdn) {
        ...
        $('*[data-fieldname="approved_requests"]').find('.btn[data-fieldname="create_purchase_invoice"]').hide();
...
frappe.ui.form.on('Fuel Requests Table', {
    ...
    form_render(frm, cdt, cdn) {
        frm.fields_dict.approved_requests.grid.wrapper.find('.btn[data-fieldname="create_purchase_invoice"]').hide();
