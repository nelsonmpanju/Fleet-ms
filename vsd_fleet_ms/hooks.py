...
scheduler_events = {
	"daily": [
		# Sync parking bills and insurance cover notes every day
		"vsd_fleet_ms.vsd_fleet_ms.utils.compliance.sync_all_parking_bills",
		"vsd_fleet_ms.vsd_fleet_ms.utils.compliance.sync_all_insurance",
	],
	"daily_long": [
